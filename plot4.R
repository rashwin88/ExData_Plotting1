...
# second plot
with(rawData, plot(Time_Stamp, Voltage, type = "n",
                   ylab = "Voltage", xlab = "datetime"))
with(rawData, lines(Time_Stamp, Voltage, lwd = 1.5))
...
legend(as.integer(as.POSIXct("2007-02-01 20:00:00")), 40, legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"),
       col=c("black", "red", "blue"), lty=1, cex=0.8)

# fourth plot
with(rawData, plot(Time_Stamp, Global_reactive_power, type = "n",
                   ylab = "Global Reactive Power (Kilowatts)", xlab = "datetime"))
with(rawData, lines(Time_Stamp, Global_reactive_power, lwd = 1.5))
